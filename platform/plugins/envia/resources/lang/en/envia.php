...
return [
    ...
    'note_2' => 'Enable "Load countries, states, cities from plugin location?" and "Enable Zip Code?" for Envia to work correctly',
    ...
    'note_5' => 'Envia only allows to create shipments with rates that are up-to-date. If expired, please fetch rates again',
    ...
    'after_service_registration_msg' => 'After registration at :name, you will have an API Key',
    ...
    'activate' => 'Activate',
    'disabled_in_demo_mode' => 'You cannot update Envia settings in demo mode!',
    'parcel' => 'Parcel',
    ...
    'transaction' => [
        'created' => 'Created shipment #:tracking',
        'view_and_create' => 'View and Create shipment',
        'create' => 'Create shipment',
        'created_success' => 'Created shipment successfully!',
        'updated' => 'Updated shipment #:tracking',
    ],
    'tracking' => [
    ...
    'not_available_in_cod_payment_method' => "Envia options won't be shown if the selected payment method is COD!",
];
