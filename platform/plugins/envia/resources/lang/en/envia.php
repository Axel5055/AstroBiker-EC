...
return [
    ...
    'note_2' => 'Enabled "Load countries, states, cities from plugin location?" and "Enable Zip Code?" for Envia to work correctly',
    ...
    'note_5' => 'Envia only allows to create transactions with shipment/rate within 24 hours, if more than 24 hours, please update the rate again',
