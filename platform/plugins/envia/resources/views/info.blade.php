    ...
    <div class="row">
        <div class="col-12 my-3 text-center">
            <div>
                @if ($image = Arr::get($rate, 'provider_image_75'))
                    <img src="{{ $image }}" alt="{{ Arr::get($rate, 'servicelevel.name') }}"
        ...
        <div class="col-12 my-2">
            <div class="row">
                ...
                <div class="col-6">
                    @if ($cod = Arr::get($shipmentEnvia, 'extra.COD'))
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>{{ trans('plugins/envia::envia.order_amount') }}</td>
        ...
        <div class="col-12 mt-2">
            <span class="fw-bold fs-5">
                {{ trans('plugins/envia::envia.parcel') }}
            </span>
            @php
                $parcel = Arr::get($shipmentEnvia, 'parcels.0');
        ...
        @php
            $url = route('envia.transactions.create', $shipment->id);
            $isShowButton = true;
        ...
        @if ($isShowButton)
            <div class="col-12 my-3">
                <button class="btn btn-primary create-transaction" data-url="{{ $url }}" type="button">
            ...
            @if (\Carbon\Carbon::now()->subHours(24)->gt($rateCreated))
                <div class="col-12 my-3">
                    ...
                    <button class="btn btn-primary get-new-rates" data-url="{{ route('envia.rates', $shipment->id) }}"
                        type="button">
                        {{ trans('plugins/envia::envia.recheck_rate') }}
                    </button>
                </div>
            @endif
        @endif
